...
ようこそ！このワークショップは、**プログラミングがはじめての方でも進められる**ように作っています。難しいコードをゼロから書く必要はありません。やることは主に「**やりたいことを日本語で AI に伝える** → **出てきた内容を一緒に確かめる**」の繰り返しです。

進めるときのコツを 3 つだけお伝えします。

- **上から順番に。** Lab 0 から順に進むと、必要な準備が自然に整います。飛ばしはおすすめしません。
- **分からない言葉があっても OK。** 初めて出てくる用語はこの後の「やさしい用語集」で短く説明しています。
- **失敗しても大丈夫。** この演習は読み取り中心で、やり直しがきくよう作ってあります。気負わず試してください。
...
最初にこれだけ知っておくと、ぐっと楽になります。完璧に覚えなくても大丈夫です。
